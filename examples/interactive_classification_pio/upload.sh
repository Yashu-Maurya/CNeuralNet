...
echo "================================================="
echo "  ESP32 Hotdog Classifier PlatformIO Uploader    "
echo "================================================="
...
python3 -m pip install pyserial Pillow || {
    echo "Warning: Failed to install Python dependencies automatically. Please run 'pip install pyserial Pillow' manually."
}

echo -e "\n---> Step 3: Launching Hotdog Serial Bridge Monitor..."
python3 classification_bridge.py
